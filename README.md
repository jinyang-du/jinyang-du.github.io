...
This repository hosts the source code for [jinyangdu.github.io](https://jinyangdu.github.io/).
It is based on the MIT-licensed [academic-homepage](https://github.com/luost26/academic-homepage) Jekyll template.
...
- Navigation and homepage display switches: `_data/navigation.yml`, `_data/display.yml`
- Publications: `_publications/`
- Updates: `_news/`

---

The original template README is kept below for reference.
